  ...
  return (
    <div className="logo">
      <svg
        ...
        width={width}
        height={height}
        viewBox="0 0 41.924 42"
        fill={fill}
      >
        <path
          d="M41.924,20.25c-0.046-1.282-0.192-2.537-0.457-3.75h-8.505V15h3v-1.5h-6V12h4.5v-1.5h-1.5V9h-3V7.5h1.5V6h-3V4.5h1.5V3
	...
	c-3.314,0-6-2.686-6-6C7.462,7.187,10.148,4.5,13.462,4.5"
        />
        <path
          d="M25.462,40.5h-1.5V39h4.5v-1.5h1.5V36h4.5v-1.5h1.5V33h-3v-1.5h-4.5V30h3v-1.5h6V27h-3v-1.5h7.005
